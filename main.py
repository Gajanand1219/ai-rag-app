...
def setup_qa_chain(vectorstore, llm):
    PROMPT_TEMPLATE = """
    "I can only answer physics questions".
...
def main():
    ...
    st.write("Ask questions based on the physics book.")

    # Check file exists
    file_path = "physic_book.txt"
    if not os.path.exists(file_path):
        st.error(f"'{file_path}' not found. Please place the file in the project directory.")
        return

    # Initialization
    with st.spinner("Processing physics book..."):
    ...
    # Question input
    st.success("✅ Ready! Ask your physics question below.")
    user_question = st.text_input("Enter your physics question:")
